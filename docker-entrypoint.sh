...
export DATABASE_HOST="confluence-cluster-640-db"
export DATABASE_USER="confluence"
export DATABASE_PASS="confluence"
export DATABASE_DB="confluence"
export LB_NAME="confluence-cluster-640-lb"
export LB_PORT="50640"
...
export SYNCHRONY_URL="http://confluence-cluster-640-lb:50640/synchrony"
...
echo -e "CATALINA_OPTS=\"-Dsynchrony.service.url=http://confluence-cluster-640-lb:50640/synchrony/v1 \${CATALINA_OPTS}\"\n" >> /confluence/atlassian-confluence-latest/bin/setenv.sh
