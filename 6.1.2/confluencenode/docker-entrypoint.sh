...
export DATABASE_HOST="confluence-cluster-612-db"
export DATABASE_USER="confluence"
export DATABASE_PASS="confluence"
export DATABASE_DB="confluence"
export LB_NAME="confluence-cluster-612-lb"
export LB_PORT="50612"
...
export SYNCHRONY_URL="http://confluence-cluster-612-lb:50612/synchrony"
...
echo -e "CATALINA_OPTS=\"-Dsynchrony.service.url=http://confluence-cluster-612-lb:50612/synchrony/v1 \${CATALINA_OPTS}\"\n" >> /confluence/atlassian-confluence-latest/bin/setenv.sh
echo -e "CATALINA_OPTS=\"-Djava.awt.headless=true \${CATALINA_OPTS}\"\n" >> /confluence/atlassian-confluence-latest/bin/setenv.sh
