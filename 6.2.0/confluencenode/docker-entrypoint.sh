...
export DATABASE_HOST="confluence-cluster-620-db"
export DATABASE_USER="confluence"
export DATABASE_PASS="confluence"
export DATABASE_DB="confluence"
export LB_NAME="confluence-cluster-620-lb"
export LB_PORT="50620"
...
export SYNCHRONY_URL="http://confluence-cluster-620-lb:50620/synchrony"
...
echo -e "CATALINA_OPTS=\"-Dsynchrony.service.url=http://confluence-cluster-620-lb:50620/synchrony/v1 \${CATALINA_OPTS}\"\n" >> /confluence/atlassian-confluence-latest/bin/setenv.sh
