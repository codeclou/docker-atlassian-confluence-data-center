...
echo ""
echo -e $C_GRN'  Create new versions of Confluence Software Data Center docker-compose files'$C_RST
...
if [ -d "docker-atlassian-confluence-data-center___master-branch" ]
then
rm -rf docker-atlassian-confluence-data-center___master-branch
fi
git clone https://github.com/codeclou/docker-atlassian-confluence-data-center.git docker-atlassian-confluence-data-center___master-branch
cd docker-atlassian-confluence-data-center___master-branch
