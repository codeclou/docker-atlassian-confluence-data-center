...
To start, scale, stop and destroy the cluster, the [`manage-confluence-cluster-7.0.1-beta1.sh`](https://github.com/codeclou/docker-atlassian-confluence-data-center/blob/master/7.0.1-beta1/manage-confluence-cluster-7.0.1-beta1.sh) script is provided.
...
#
curl -so /usr/local/bin/manage-confluence-cluster-7.0.1-beta1.sh \
"https://raw.githubusercontent.com/codeclou/docker-atlassian-\
confluence-data-center/master/7.0.1-beta1/manage-confluence-cluster-7.0.1-beta1.sh"

#
# MAKE EXECUTABLE
#
chmod +x /usr/local/bin/manage-confluence-cluster-7.0.1-beta1.sh
```
...
**(1) Start a Confluence® Data Center 7.0.1-beta1 Cluster**

```bash
manage-confluence-cluster-7.0.1-beta1.sh --action create --scale 1
```
...
```bash
manage-confluence-cluster-7.0.1-beta1.sh --action info
```
...
```bash
manage-confluence-cluster-7.0.1-beta1.sh --action update --scale 3
```
...
```bash
manage-confluence-cluster-7.0.1-beta1.sh --action restart-node --id 3
```
...
```bash
manage-confluence-cluster-7.0.1-beta1.sh --action destroy
```
