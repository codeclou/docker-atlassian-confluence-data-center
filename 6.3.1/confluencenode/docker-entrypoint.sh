...
export DATABASE_HOST="confluence-cluster-631-db"
export DATABASE_USER="confluence"
export DATABASE_PASS="confluence"
export DATABASE_DB="confluence"
export LB_NAME="confluence-cluster-631-lb"
export LB_PORT="50631"
...
export SYNCHRONY_URL="http://confluence-cluster-631-lb:50631/synchrony"
...
echo -e "CATALINA_OPTS=\"-Dsynchrony.service.url=http://confluence-cluster-631-lb:50631/synchrony/v1 \${CATALINA_OPTS}\"\n" >> /confluence/atlassian-confluence-latest/bin/setenv.sh
